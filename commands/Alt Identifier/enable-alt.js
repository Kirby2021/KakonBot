  ...
  run: async(client, message, args) => {
    ...
    schema.findOne({ Guild: message.guild.id }, async(err, data) => {
      ...
      if(avatar == 'true') {
        ...
        message.channel.send(`● Saved ! Alt Identifier Module Settings: Minimum Age: \`${day} days\` , Avatar: \`Enabled\``)
        ...
        message.channel.send(`● Saved ! Alt Identifier Module Settings: Minimum Age: \`${day} days\` , Avatar: \`Disabled\``)
      }
      })
    }
}